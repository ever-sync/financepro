...
const categories = ["Aluguel/Moradia", "Condomínio", "Energia", "Água", "Internet", "Telefone", "Plano de Saúde", "Escola/Faculdade", "Seguro", "Streaming", "Academia", "Outros"];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Contas Fixas - Pessoal</h1>
          <p className="text-sm text-muted-foreground">Despesas recorrentes da sua vida pessoal</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
              <DialogHeader><DialogTitle>Nova Conta Fixa Pessoal</DialogTitle></DialogHeader>
